...
public class Gamefield extends GameSet{
	...
	void input() {
	    ...
	    }while(random1 < 1 || random2 < 1 || random1 > field.length-2 || random2 > field[0].length-2);
	    treasure = new int[random1][random2];
	}
	...
	void field() {
		...
		}while(mon_random1 < 1 || mon_random2 < 1 || mon_random1 > field.length-2 || mon_random2 > field[0].length-2);
